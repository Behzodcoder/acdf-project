    ...
    <div className="container">
      <div className="gallery">
        ...
        <div className="gallery-info">
          ...
          <p className="fond">
            Фонд развития культуры и искусства при Кабинете Министров Республики
            Узбекистан является инициатором крупных архитектурных проектов в
            Ташкенте.
          </p>
          <p className="readMore">Читать далее</p>
        </div>
        {/* <img className="gumbazTwo" src={gumbaz2} alt="" /> */}
      </div>
      ...
      <div className="gallery">
        <div className="gallery-info">
          ...
          <p className="fond">
            ...
            выставок, демонстрирующих богатую и яркую культуру и историческое
      ...
      <div className="gallery">
        ...
        <div className="gallery-info">
          <h2>Организация <br /> мероприятий</h2>
          <p className="fond">
            Фонд регулярно организует и поддерживает мероприятия в области
            изобразительного искусства, литературы, театра, музыки, архитектуры
            и хореографии. Фонд устанавливает международные культурные связи и
            продвигает культуру Узбекистана на мировой арене.
          </p>
          <p className="readMore">Читать далее</p>
        </div>
      </div>
      ...
      <div className="gallery">
        ...
        <div className="gallery-info">
          ...
          <p className="fond">
            ...
            общественности к проблеме инклюзии и доступности объектов культуры
      ...
      <div className="gallery">
        <div className="gallery-info">
          ...
          <p className="fond">
            ...
            состоит из множества элементов и тесно связана с другими программами
            Фонда.
          </p>
          <p className="readMore">Читать далее</p>
        </div>
      ...
      <div className="gallery">
        ...
        <div className="gallery-info">
          ...
          <p className="fond">
            ...
            поддержки культуры. Это законы «О меценатстве», «О целевых капиталах
            некоммерческих организаций», а также Постановление Кабинета
            министров «Об утверждении типового положения о попечительских
            советах учреждений культуры и искусства».
          </p>
          <p className="readMore">Читать далее</p>
        </div>
      </div>
